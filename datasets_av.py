...
from masking_generator import TubeMaskingGenerator, TubeWindowMaskingGenerator, RandomMaskingGenerator2D, TimeMaskingGenerator2D
...
class MaskGeneratorForAudio(object):
    def __init__(self, mask_type, input_size, mask_ratio):
        if mask_type == 'random':
            ...
            self.masked_position_generator = TimeMaskingGenerator2D(
                input_size, mask_ratio
            )
        else:
